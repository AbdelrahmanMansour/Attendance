...
public class GenerateData {
    ...
    public void generateData() {
        ...
        // create Scanner
        Scanners scannerEating = new Scanners("11111111", dainingHall, eatingAccount);
        Scanners scannerAttendance1 = new Scanners("22222222", library, attendenceAccount);
        Scanners scannerAttendance2 = new Scanners("33333333", verillHall, attendenceAccount);
        Scanners scannerVirtualDolar = new Scanners("44444444", guy, virtualDolarAccout);
